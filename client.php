...
<!-- <div class="row">  -->
    ...
    <div class="row"> 
                <div class="col-12 col-md-6 row">
                    <div class="col-2"> <h1 class="bignum text-center pt-3"> 1 </h1> </div>
                        ...
                        <div class="col-4 pt-2 ic1" style="border-radius: 100%" >
                            <lord-icon
                ...
                <div class="col-12 col-md-6 row"> 
                    ...
                    <div class="col-6"> <h5> BROWSE THROUGH</h5>
    ...
    <div class="row"> 
            <div class="col-12 col-md-6 row "> 
                    ...
                    <div class="col-6"> <h5> PROFILING </h5>
                ...
                <div class="col-12 col-md-6 row"> 
                    ...
                    <div class="col-6"> <h5> MAKE CONTACTS </h5>
        ...
        <div class="row"> 
                ...
                <div class="col-12 col-md-6 row"> 
                    ...
                    <div class="col-6"> <h5> FEEDBACKS</h5>
